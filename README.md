...
- `scripts/build_figure_source_data_from_legacy.py`: optional maintainer script for rebuilding the CSVs from a private legacy subset supplied as a command-line argument.
...
- Confirm the partial processed CSV values are the intended representative subset for public release.
